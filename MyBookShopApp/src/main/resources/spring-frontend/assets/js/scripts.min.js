                        ...
                        if (!error) {
                            Login().postData('/api/bookReview', {
                                ...
                                if (result.result) {
                                    ...
                                    $textarea.addClass('form-textarea_error').after('<div class="form-error">' + 'Оставить отзыв можно только после покупки книги' + '</div>');
                                }
                            })
                        }
                    });
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/api/rateBookReview', data, function (result) {
                            if (result != null && result.result) {
                                ...
                                $title.addClass('Rating-title_error').text('Дать оценку отзывам можно только после покупки книги');
                            }
                            setTimeout(function () {
                                $title.remove();
                            }, 2500);
                        ...
                        if ($this.find('#name').length && $this.find('#mail').length) {
                            ...
                            if (!data.name || !data.mail) {
                                if (!$infoPlace.next().hasClass('form-error')) {
                                    $infoPlace.after('<div class="form-error">' + 'Не все поля заполнены' + '</div>');
                                }
                                return;
                            }
                        }
                            ...
                            Login().postData('/contacts', data, function (result) {
                                if (result.result) {
                                    if (!$infoPlace.next().hasClass('form-info')) {
                                        ...
                                        $infoPlace.after('<div class="form-info">Форма отправлена</div>');
                                    }
                                } else {
                                    if (!$infoPlace.next().hasClass('form-error')) {
                                        $infoPlace.after('<div class="form-error">' + 'Не все поля заполнены' + '</div>');
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/reg/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                ...
                                $row.find('.form-input[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь с данным номером уже зарегистрирован' + '</div>');
                            }
                        })
                    });
                    $('#submitMail').on('click', function () {
                        ...
                        postData('/reg/requestEmailConfirmation', data, function (result) {
                            if (result.result) {
                                ...
                                $row.find('.form-input[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь с данным адресом уже зарегистрирован' + '</div>');
                            }
                        })
                    });
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $but.after('<div class="Profile-success"><div class="form-info">Код успешно подтвержден</div></div>');
                                    $this.trigger('change');
                                } else {
                                    if (result) {
                            ...
                            if (!error && $this.data('type') === 'phone') {
                                postData('/requestContactConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                                        ...
                                        $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Wrong phone number' + '</div>');
                                    }
                                })
                                ...
                                postData('/requestEmailConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                                        ...
                                        $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Wrong email' + '</div>');
                                    }
                                })
                                ...
                                postData('/login-by-email', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Wrong code' + '</div>');
                                        }
                                    }
                                })
                                ...
                                postData('/login-by-phone-number', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Введен неверный код' + '</div>');
                                        }
                                    }
                                })
                                ...
                                postData('/login-by-pass', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Введен неверный e-mail/телефон или пароль' + '</div>');
                                        }
                                    }
                                })
                            }
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/api/rateBook', {
                            ...
                            if (result.result) {
                                ...
                                $title.addClass('Rating-title_error').text('Оценить книгу можно только после ее покупки');
        ...
        var Profile = function () {
            ...
            return {
                init: function () {
                    ...
                    $Profile.find('input[name="mail"], input[name="phone"], input[name="name"], input[name="password"], input[name="passwordReply"]').on('change', function () {
                        var $this = $(this);
                        if ($('#profile_submit_mail').is(":hidden") && $('#profile_submit_phone').is(":hidden")) {
                            $('.Profile-btn').find('.btn_primary').prop('disabled', false);
                        }
                    });
                    ...
                    $Profile.find('input[name="mail"], input[name="phone"]').on('change', function () {
                        var $this = $(this);
                        if (($this.val().includes("@") ? $this.val() : $this.val().replace(/[( )\-]/g, "")) === $this.attr('value')) {
                    ...
                    $('form.Profile-form').on('submit', function (e) {
                        ...
                        if ($name === "") {
                            $Profile.find('[name="name"]').after('<div class="form-error">' + '<div class="form-error">' + 'Заполните имя' + '</div>' + '</div>')
                        } else if ($mail.val() !== $mail.attr("value") && !$mail.closest(".form-group").hasClass('form-group_confirm')) {
                            $Profile.find('[name="mail"]').after('<div class="form-error">' + '<div class="form-error">' + 'Подтвердите почтовый адрес' + '</div>' + '</div>')
                        } else if ($phone.val().replace(/[( )-]/g, "") !== $phone.attr("value").replace(/[( )-]/g, "") && !$phone.closest(".form-group").hasClass('form-group_confirm')) {
                            $Profile.find('[name="phone"]').after('<div class="form-error">' + '<div class="form-error">' + 'Подтвердите номер телефона' + '</div>' + '</div>')
                        } else if ($password.val() !== $passwordReply.val()) {
                            if (!$Profile.find('[name="password"]').next().hasClass('form-error')) {
                                $Profile.find('[name="password"]').after('<div class="form-error">' + '<div class="form-error">' + 'Пароли должны совпадать' + '</div>' + '</div>')
                                $Profile.find('[name="passwordReply"]').after('<div class="form-error">' + '<div class="form-error">' + 'Пароли должны совпадать' + '</div>' + '</div>')
                            }
                        } else {
                            Login().postData('/profile', {
                                    ...
                                    if (result.result) {
                                        ...
                                        if (!$submitBtn.closest('div').siblings('.Profile-success, .form-error').length) {
                                            $submitBtn.closest('div').after('<div class="Profile-success">' + '<div class="form-group">' + 'Профиль сохранен' + '</div>' + '</div>')
                                        }
                                        ...
                                        $submitBtn.closest('div').after('<div class="form-error">' + '<div class="form-group">' + 'Ошибка' + '</div>' + '</div>')
                                    }
                    ...
                    $('#profile_submit_phone, #profile_submit_mail').on('click', function () {
                        ...
                        if ($this.is('#profile_submit_phone')) {
                            Login().postData('/reg/requestContactConfirmation', data, function (result) {
                                if (result.result) {
                                    $codeInput.show();
                                    $this.closest('div').append('<div class="form-group">' + '<div class="form-info">' + 'Введите последние 4 цифры с номера, который сейчас позвонит на этот телефон' + '</div>' + '</div>')
                                    $this.attr('disabled', 'disabled');
                                    $form.addClass('form-group_confirm');
                                    $codeInput.prop('disabled', false);
                                    $form.find('.form-error').remove();
                                } else {
                                    $contactInput.addClass('form-input_error').after('<div class="form-error">' + 'Пользователь с данным номером уже зарегистрирован либо не существует' + '</div>');
                                }
                            })
                        }
                        if ($this.is('#profile_submit_mail')) {
                            Login().postData('/reg/requestEmailConfirmation', data, function (result) {
                                if (result.result) {
                                    $codeInput.show();
                                    $this.closest('div').append('<div class="form-group">' + '<div class="form-info">' + 'Введите код отправленный на данный почтовый адрес' + '</div>' + '</div>')
                                    $this.attr('disabled', 'disabled');
                                    $form.addClass('form-group_confirm');
                                    $codeInput.prop('disabled', false);
                                    $form.find('.form-error').remove();
                                    ...
                                    if (!$contactInput.hasClass('form-input_error')) {
                                        $contactInput.addClass('form-input_error').after('<div class="form-error">' + 'Пользователь с данным почтовым адресом уже зарегистрирован либо не существует' + '</div>');
                                    }
                                }
                            })
                        }
                        $codeInput.on('blur', function () {
                            ...
                            Login().postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $form.find('.form-error').remove();
                                    $this.removeClass('form-input_error');
                                    $codeInput.after('<div class="form-group"></div><div class="form-info">Код успешно подтвержден</div></div>');
                                    ...
                                    if (result) {
                                        // $row.removeClass('form-group_confirm');
                                        $this.val('');
                                        $but.text('Отправить код повторно');
                                        $but.prop('disabled', false);
                                        if (!$codeInput.hasClass('form-input_error')) {
                                            $codeInput.addClass('form-input_error').after('<div class="form-error">' + 'Неверный код или контакт' + '</div>');
                ...
                init: function () {
                    $('form.Topup').on('submit', function (e) {
                        ...
                        if (!$topupSum.val() || $topupSumVal < 50) {
                            $topupSum.closest('div').after('<div class="form-error">' + 'Введите сумму больше 50 р.' + '</div><div class="form-group"></div>')
                        } else {
                        ...
                        $('#confirm-purchase_btn').on('click', function (e) {
                            ...
                            $.getJSON('/api/payment', {}, function (result) {
                                    if (result.result) {
                                        ...
                                        $budget.text('На счете ' + ($oldBudgetVal - $sum) + ' руб.')
                                        $('.Cart-product').remove();
                                        $('.Cart-block_total').children().remove();
                                        $cart.find('.Cart-total .btn').attr('disabled', 'disabled');
                                        $cart.prepend('<div class="Cart-messageInfo">Оплата прошла успешно!</div>');
