...
public interface BookRepository extends JpaRepository<BookEntity, Integer> {
    ...
    String SHORT_BOOK_SELECT_CLAUSE =
            "select         slug, " +
                    ...
                    "       price, " +
                    "       discountPrice, " +
                    "       array_to_string(authors_array, ', ') authors ";
    ...
    Optional<FullBookDto> getFullBookInfo(
    ...
    @Query(value = SHORT_BOOK_SELECT_CLAUSE +
            ...
            "      group by b.id " +
            ")  as recommended_books  " +
            " order by rating_value desc nulls last, pub_date desc",
            nativeQuery = true,
            countQuery = "select count(*) from books")
    Page<ShortBookDtoProjection> getRecommendedBooks(Pageable nextPage);
    ...
    @Query(value = SHORT_BOOK_SELECT_CLAUSE +
            ...
            nativeQuery = true,
            countQuery = "select count(*) from books")
    Page<ShortBookDtoProjection> getRecentBooksByPubDate(@Param("from") LocalDate periodFrom, @Param("to") LocalDate periodTo, Pageable nextPage);
    ...
    @Query(value = SHORT_BOOK_SELECT_CLAUSE +
            ...
            nativeQuery = true,
            countQuery = "select count(*) from books")
    Page<ShortBookDtoProjection> getPopularBooks(Pageable pageable);
    ...
    @Query("select new com.example.mybookshopapp.dto.book.BookDto(" +
            "b.slug, b.title, b.description, b.pubDate, " +
            "b.price, b.discount, b.isBestseller, b.image" +
            ") from BookEntity b " +
            "where b.slug like ?1")
    BookDto getBookDtoBySlug(String slug);
