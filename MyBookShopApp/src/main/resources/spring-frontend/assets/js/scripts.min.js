                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        if (!result.responseJSON.hasNext) {
                                    ...
                                    if (result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            if (!$codeInput.hasClass('form-input_error')) {
                                                $codeInput.addClass('form-input_error').after('<div class="form-error">' + 'Wrong code or phone number' + '</div>');
                    ...
                    $('#buy_btn').on('click', function (e) {
                        ...
                        $.getJSON('/api/payment', {}, function (result) {
                                if (result.result) {
                                    ...
                                    $this.closest('div').append('<div class="form-error">' + '<div class="Topup-success">' + result.error + '</div>' + '</div>')
                                }
                            }
                        )
                    });
